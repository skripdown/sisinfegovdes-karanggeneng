            ...
            <div class="col-12 bg-white" style="border-radius: 1.5%; padding-bottom: 1vw">
                <div class="p-3">
                    <h2 class="text-center">
                        <img src="{{asset(env('ICON_PATH'))}}" alt="" style="width: 100pt;">
                    </h2>
                    <p class="text-center">Masukkan ID dan kata sandi untuk mengakses {{env('APP_NAME')}}.</p>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control{{ $errors->has('identity') ? ' is-invalid' : '' }}" id="identity" type="text" placeholder="masukkan email atau NIK" name="identity" required autofocus>
