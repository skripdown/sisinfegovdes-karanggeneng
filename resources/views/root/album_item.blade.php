...
<head>
    ...
    <link rel="stylesheet" href="{{asset(env('CSS_PATH').'photogrid.css')}}">
</head>
    ...
    <div class="container">
        <section class="digital-marketing-service" id="digital-marketing-section">
            <div class="content-header text-center mb-4 pb-2">
                <h2>Nama Album</h2>
                <h6 class="section-subtitle text-muted pb-4 mb-2">Deskripsi Album.</h6>
            </div>
            <div id="photos">
                <img src="{{asset('sub/images/team-1.png')}}" alt="">
                <img src="{{asset('sub/images/team-2.png')}}" alt="">
                <img src="{{asset('sub/images/team-2.png')}}" alt="">
                <img src="{{asset('sub/images/team-2.png')}}" alt="">
                <img src="{{asset('sub/images/team-2.png')}}" alt="">
                <img src="{{asset('sub/images/team-2.png')}}" alt="">
