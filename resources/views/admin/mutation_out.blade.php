...
@section('sub-breadcrumb')
    Halaman Kelola Mutasi Keluar Kepegawaian {{env('APP_NAME')}}
@endsection
...
@section('script-body')
    <script>
        ...
        _card.render({
            ...
            items : [
                {
                    title : 'Data Permintaan Mutasi Keluar',
                    label : 'ti-user',
                    id : 'data-mutasi-keluar',
            ...
            items   : [
                {
                    ...
                    label : 'ti-user',
                    id : 'his-mutasi-keluar',
                    content : _tables.render({
                        element : 'table-his-out',
                        template : 'custom',
                        column : [
                            {content : 'Profil'},
                            {content : 'Jenis'},
